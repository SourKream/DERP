...
def get_options(args):
	...
	if args.bad_grammar:	
		options['TRAIN'] = options['DATA_DIR'] + 'RUBER_GOLD_train_with_incorrect_grammar.txt'
		options['VAL'] =  options['DATA_DIR'] + 'RUBER_GOLD_val_with_incorrect_grammar.txt'
	else:
		options['TRAIN'] = options['DATA_DIR'] + 'RUBER_GOLD_train.txt'
		options['VAL'] =  options['DATA_DIR'] + 'RUBER_GOLD_val.txt'

	# Now the model save path
	options['SAVE_DIR'] = "/scratch/cse/btech/cs1130773/DERPData/Models_Clean/RUBER/DERP_With_Gold/"
	#options['SAVE_DIR'] = "/scratch/cse/btech/cs1130773/DERPData/Models_Clean/RUBER/DERP_With_Gold_Archive/"
