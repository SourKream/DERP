...
class AttentionDecoderGRU(GRU):
    ...
    def __init__(self, units, attn_dense_dim, return_sequences=True, **kwargs):
    ...
    def preprocess_input(self, inputs, training = None):
        return super(AttentionDecoderGRU, self).preprocess_input(inputs[0], training)

    def get_constants(self, inputs, mask, training = None):        
        constants = super(AttentionDecoderGRU, self).get_constants(inputs[0], training)        
